<%-- 
    Document   : ViewSecretaria
    Created on : 27/05/2019, 11:41:10 AM
    Author     : steve
--%>
...
<html>
    ...
    <body>
        ...
        <div class="modal fade" id="razonr" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="titulo2"></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        ...
        function filaSol(listado, solicitud) {
            ...
            tr.html(
                    ...
                    + "<option value=\"estado\">" + solicitud.estado + "</option>"
